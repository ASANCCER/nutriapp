    ...
    return Scaffold(
      body: Stack(
        children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                                ...
                                color: Colors.black,
                                child: Utiles.textoCentrado('NUEVO INGREDIENTE',
                                    Colors.white, 'newton')),
                            Padding(
                    ...
                    floatingActionButton: FloatingActionButton(
                      ...
                      onPressed: () async {
                        ...
                        if (tipoComida != null &&
                          ...
                          // Mostrar el AlertDialog cuando hay campos vacíos
                          showDialog(
                            context: context,
                            builder: (BuildContext context) {
                              return AlertDialog(
                                title: Utiles.textoCentrado(
                                    "ERROR", Colors.black, "dash"),
                                content: Utiles.textoCentrado(
                                ...
                                actions: [
                                  TextButton(
                                    onPressed: () {
                                      // Cerrar el pop-up cuando se presiona el botón "OK"
                                      Navigator.of(context).pop();
                                    },
                                    child: Utiles.textoCentrado(
                                    "OK", Colors.black, "dash"),
                                  ),
                                ],
                              );
                            },
          ...
          Utiles.botonVolver(context, "MENU")
        ],
      ),
    );
  }
